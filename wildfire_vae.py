...
def main(args):
    ...
    train_loader = DataLoader(viirs_dataset, batch_size=256, shuffle=False, num_workers=4)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load-records', default=1000, type=int, help='number of record to load')
